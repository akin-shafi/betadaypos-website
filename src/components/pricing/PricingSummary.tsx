      ...
      <AnimatePresence>
        {!hide && (
          <motion.div 
            ...
            className="max-w-4xl mx-auto bg-slate-900/95 backdrop-blur-md text-white p-6 rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] flex flex-col md:flex-row items-center justify-between gap-6 pointer-events-auto border border-white/10"
          >
